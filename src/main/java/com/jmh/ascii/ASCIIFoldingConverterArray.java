...
/**
 * This is an extension of org.apache.lucene.analysis.miscellaneous.ASCIIFoldingFilter.
 * Difference is that the converter will remove all not-converted characters if analog of the character was not found.
 */
public class ASCIIFoldingConverterArray {

    private ASCIIFoldingConverterArray() {}
    ...
    public static String foldToASCII(String inputString) {
        ...
        CharArray out = new CharArray(length);
        ...
        for (int pos = inputPos; pos < end ; ++pos) {
            ...
            if (c < '\u0080') {
                ...
                switch (c) {
                    ...
                    default:
                        // Customization start
                        // Do not preserve non-ascii chars in the final string if analog was not found.
                        if (c < 128) {
                            out.add(c);
                        }
                        break;
        ...
        return new String(out.getArray());
    }
